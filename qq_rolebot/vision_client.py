...
from qq_rolebot.vision_types import IdentityCandidate, LensEvidence, VisionObservation
...
class VisualAnalyzer:
    ...
    async def describe_dynamic_media(
        ...
        *,
        ...
        payload = self._payload(content=content, schema=self._analysis_schema())
        data, error = await self._request(
            payload,
    ...
    def _payload(self, *, content: list[dict[str, Any]], schema: dict[str, Any]) -> dict[str, Any]:
        return {
        ...
        *,
        ...
        try:
            async with httpx.AsyncClient(
                ...
                response = await client.post(f"{self.api_base}/chat/completions", json=payload)
