...
def test_serpapi_clients_drop_dual_lens_and_candidate_verification_methods() -> None:
    assert not hasattr(SerpApiLensClient, "search")
    assert not hasattr(SerpApiWebClient, "verify")
