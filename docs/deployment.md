...
VISION_CACHE_PATH=/opt/qq-rolebot/data/vision_cache.sqlite3
SERPAPI_API_KEY=
...
```bash
/opt/miniconda3/envs/qq-rolebot/bin/python scripts/summarize_vision_traces.py data/debug_traces
```
